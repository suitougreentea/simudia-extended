<template>  
  <defs>
    ...
    <symbol id="stations-hover">
      <line v-for="(s, i) in gui.stations" :x1="gui.layout.left" :x2="gui.layout.right" :y1="gui.y(s.accumulatedTime)" :y2="gui.y(s.accumulatedTime)" stroke="transparent" stroke-width="10"
        @mousemove="hoverStationLine(s, $event)" @mouseout="unhoverStationLine(s, $event)" @click.prevent.stop="clickStationLine(s, $event)" @contextmenu.prevent.stop="contextStationLine(s, $event)"></line>
    </symbol>
  </defs>
</template>
